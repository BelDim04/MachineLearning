...
class KNearestNeighbor:
    ...
    def compute_distances_no_loops(self, X):
        ...
        #########################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        dists = (((X ** 2).sum(axis=1)).reshape(num_test, 1) + (self.X_train ** 2).sum(axis=1) - X @ self.X_train.T * 2) ** 0.5
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            #########################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            neighbors = np.take(self.y_train, np.argsort(dists[i])[:k])
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            #########################################################################
            # TODO:                                                                 #
...
a = np.array([[1, 2], [3, 4]])
b = np.array([[1, 2], [7, 8]])
print(((a ** 2).sum(axis=1)).reshape(2, 1) + ((b ** 2).sum(axis=1)) - a @ b.T * 2)
